...
class ResourceNotFoundExceptionSpec extends Specification {
    ...
    def "paymentNotFound should create exception with correct error code"() {
        ...
        when:
        def exception = ResourceNotFoundException.paymentNotFound(paymentId)
    ...
    def "accountNotFound should create exception with correct error code"() {
        ...
        when:
        def exception = ResourceNotFoundException.accountNotFound(accountId)
    ...
    def "senderAccountNotFound should create exception with correct error code"() {
        ...
        when:
        def exception = ResourceNotFoundException.senderAccountNotFound(accountId)
    ...
    def "receiverAccountNotFound should create exception with correct error code"() {
        ...
        when:
        def exception = ResourceNotFoundException.receiverAccountNotFound(accountId)
